...
const representation = {
    ...
    artifactId: 'art_1',
    contentHash: hash,
    objectKey: `conversions/${hash}/v1.md`,
    contentType: 'text/markdown',
    converterRef: 'docling-v1',
    text: 'An inspectable fixture passage.',
    createdAt: now,
};
const storedAnchor = {
    id: 'anchor-1',
    ...
    sourceVersionId: 'sv_1',
    artifactId: 'art_1',
    spans: [{ start: 3, end: 14 }],
    quote: { prefixDigest: 'a', exactDigest: 'b', suffixDigest: 'c', normalizationVersion: 'nfc-ws-v1' },
...
describe('N4 qualification persistence', () => {
    ...
    it('copies only permitted project membership and records denied transfers without mutation', async () => {
        ...
        await store.recordTransfer({
            sourceProjectId: 'n4-a',
            targetProjectId: 'n4-b',
            contentHash: hash,
            allowed: false,
