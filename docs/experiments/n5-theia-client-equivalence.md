...
|---|---|---|---|
| Theia source fork | 1.75.0; API constant 1.130.0 | Repository EPL-2.0 OR GPL-2.0-only WITH Classpath-exception-2.0 | Build/runtime recorded separately; API constant alone proves no behaviors |
